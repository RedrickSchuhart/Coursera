...
void TestTime() {
    vector<string> docs, queries;
    string str;
    str="just like exception safety is not about writing try catch everywhere in your code move semantics are not about typing double ampersand everywhere in your code";
    for(size_t i=0; i<50000; i++) {
        docs.push_back(str+str);
    }
    str="just like exception safety is not about writing try daddy";
    ...
    cout << "Document count = 50000, words in a document = 50, \
queries count = 1000, words in a query = 10" << endl;
    SearchServer srv;
    {
